...
public class SearchRoleFilterPage extends DriverUtil {
    ...
    //By ResultsXpath = By.xpath("//*[@id=\"form_id\"]/div[8]/div/div[2]/div/div[1]/a");
     By ResultsXpath = By.xpath("//*[@class='absolute inset-0']");
   ...
   public void EnterSearchCriteria (io.cucumber.datatable.DataTable SearchCriteria){
    ...
    public void VerifyResults (){
        List<WebElement> results = driver.findElements(ResultsXpath);
